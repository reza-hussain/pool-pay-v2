...
- A spend at or below what the recorder has left in their own remaining balance (see [ADR-0020](0020-per-member-balance-refund-formula.md)) fires immediately, no approval needed — it's just spending your own money.
